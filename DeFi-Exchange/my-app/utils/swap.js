...
/**
* getAmountOfTokensReceivedFromSwap:  Returns the number of Eth/Crypto Dev
* tokens that can be received when the user swaps `_swapAmountWei` amount of
...
export const getAmountOfTokensReceivedFromSwap = async (
  ...
  let amountOfTokens;
  /**
  * If `Eth` is selected this means our input value is `Eth` which means our
  * input amount would be `_swapAmountWei`, the input reserve would be the
  * `ethBalance` of the contract and output reserve would be the `Crypto Dev`
  * token reserve
  */
  if (ethSelected) {
    ...
    /**
    * If `Eth` is not selected this means our input value is `Crypto Dev` tokens
    * which means our input amount would be `_swapAmountWei`, the input reserve
    * would be the `Crypto Dev` token reserve of the contract and output reserve
...
* `tokenToBeReceivedAfterSwap` amount of Eth/Crypto Dev tokens.
*/
