 ...
 * If the user is adding initial liquidity, user decides the ether and CD tokens
 * they wants to add to the exchange. If they are adding the liquidity after the
 * initial liquidity has already been added then we calculate the Crypto Dev
 * tokens they can add, given the Eth they want to add by keeping the ratios
 * constant.
 */
